...
>
> 上次 sync: 2026-06-03（手工补 back-to-top 一条 —— bin/sync-index.sh 当前在 macOS BSD sed 崩 + 重建会丢 Bundle 列/串 node 字段，已修 sed 崩，余下重建 bug 待后续修后再交还脚本托管）
...
|---|---|---|---|---|---|
| back-to-top | [jd-design-system-md-v16/foundations/components-base/back-to-top/design.md](../../../jd-design-system-md-v16/foundations/components-base/back-to-top/design.md) | **page-doc** (5 files) | `2029484645871009793 / 1382:4926 / 1382:4932` | @xushui2018 | 2026-06-03 |
